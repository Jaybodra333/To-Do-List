								...
								<tbody> 
									{todoList.map((data) => ( 
										<tr key={data._id}> 
											...
											<td> 
												{editableId === data._id ? ( 
													<button className="btn" onClick={() => saveEditedTask(data._id)}> 
														Save 
													</button> 
												) : ( 
													<button className="btn" onClick={() => toggleEditable(data._id)}> 
														Edit 
													</button> 
												)} 
												<button className="btn" onClick={() => deleteTask(data._id)}> 
													Delete 
												</button> 
											</td> 
										</tr> 
